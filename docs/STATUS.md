...
| 25 | القوالب الثمانية عند Meta | ⚠️ 6 جاهزة، واثنان متعثران (09-25) | ستة APPROVED/UTILITY انتقلت أغراضها (الترحيل 19:22 UTC). قائمة الشراء: v2 ما زال PENDING. تنبيه المالك: v2 MARKETING وv3 REJECTED (`INCORRECT_CATEGORY`)، وينتظر قرار براء (§ 25) |
...
| purchase_list_remind | `utak_purchase_list_remind_v2` | **PENDING** / UTILITY (قيد المراجعة) | [رقم القائمة، التاريخ، العدد] + `purchase_done_` | [team.ts:335](../src/team.ts) |
