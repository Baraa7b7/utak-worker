...
| 1 | النشر | ✅ جاهز (تحديث 09-23) | نسخة sim هي `f62f7721` (2026-09-23)، ونسخة prod `5c138821` بلا تغيير. **جدولة prod كانت فعّالة فعلياً** (سبب التكرار) وفُرّغت عبر API؛ الكرون الآن على sim فقط فعلاً. `ACCOUNTING_SYNC=true` على sim |
...
| 4 | خريطة الربط | ✅ مكتملة لقائمة الدخل (09-23) | ثلاثة تدفقات آلية تكتب قيوداً (الفاتورة والتحصيل وفاتورة المورد). المصاريف تُدخل يدوياً كفواتير موردين على يومية EXP، والرواتب قيد شهري يدوي بسكربت (§ 13). بقي رأس المال والقيد الافتتاحي والإقفال الشهري |
...
6. **قيد رأس المال الافتتاحي** على 300010، ثم القيد الافتتاحي والإقفال الشهري (التالي بعد § 13).
6b. ~~**المصاريف والرواتب**~~ ✅ 2026-09-23 (§ 13). **بقي:** تعبئة `x_monthly_salary` للموظفين (كلها فارغة اليوم)، والسجل 10 «محمد المحصّل - اختبار» له دور محصّل وهو غير معلَّم كمحاكاة.
