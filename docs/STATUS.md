...
| 1 | النشر | ✅ جاهز (تحديث 09-24) | نسخة sim هي `8827d0b1` (2026-09-24، التوقيع والقوائم)، وقبلها `06fa597f` (QR والختم)، وقبلها `f62f7721` (2026-09-23)، ونسخة prod `5c138821` بلا تغيير. **جدولة prod كانت فعّالة فعلياً** (سبب التكرار) وفُرّغت عبر API؛ الكرون الآن على sim فقط فعلاً. `ACCOUNTING_SYNC=true` على sim |
...
| 6 | الهوية الرسمية | ✅ مكتملة (09-24) | الاسم «شركة يوتاك ذات مسؤولية محدودة» متصلاً، والرقم الضريبي، والسجل التجاري 7055194869 (`SA_CRN`)، والختم الأخضر، والتوقيع المعتمد (أسود على شفاف 1600 px)، والعنوان الوطني كاملاً بالعربية والإنجليزية (§ 15، § 16). **ناقص:** الاسم القانوني بالإنجليزية `x_legal_name_en` (فارغ؛ القوائم تطبع «UTAK») |
