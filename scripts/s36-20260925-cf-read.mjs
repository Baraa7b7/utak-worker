// Read-only Cloudflare API snapshot (STATUS § 36): deployed versions of prod and
...
//
//   node scripts/s36-20260925-cf-read.mjs <label>
//
// Out: scripts/artifacts/s36-20260925-cf-<label>.json
...
writeFileSync(new URL(`./artifacts/s36-20260925-cf-${label}.json`, import.meta.url), JSON.stringify(out, null, 2) + "\n");
