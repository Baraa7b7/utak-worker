// § 36 (أ) — every UTAK template at Meta, read only (GET), next to its Odoo row.
//
//   node scripts/s36-20260925-meta-templates.mjs <label>
//
// Meta: GET /message_templates only — no create, edit, delete or re-submit.
// Odoo: search_read only. Out: scripts/artifacts/s36-20260925-meta-templates-<label>.json
...
writeFileSync(new URL(`./artifacts/s36-20260925-meta-templates-${label}.json`, import.meta.url), JSON.stringify(out, null, 2) + "\n");
for (const t of list) {
